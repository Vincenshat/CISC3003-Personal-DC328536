<?php
	...
	// Process checkout and save order information
	if (isset($_POST['action']) && isset($_POST['action']) == 'order') {
	  ...
	  if (!isset($_POST['pmode']) || empty($_POST['pmode'])) {
	      // Handle error - pmode not selected or empty
	      // Option 1: Set a default value if appropriate (e.g., 'cod')
	      // $pmode = 'cod'; 
	      // Option 2: Return an error message to the user
	      echo '<div class="alert alert-danger alert-dismissible mt-2">'
	              .'<button type="button" class="close" data-dismiss="alert">&times;</button>'
